...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright dpenny, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/WickedDistortion-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/WickedDistortion-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/WickedDistortion-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/WickedDistortion-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/WickedDistortion-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/WickedDistortion-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/WickedDistortion-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/WickedDistortion.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/WickedDistortion.iss",inplace=1):
